...
\frame{
    ...
    \begin{itemize}
        ...
        \item Helps illustrate \alert{architectural issues} in interactive systems
...
\frame{
    ...
    \begin{columns}
        \column{.6\textwidth}
            \begin{itemize}
                \item How complex is a task? Allows experts to describe them
                \item Ensures each task can be completed
                \item Allow \alert{errors} or \alert{omissions} in flows to be identified
                \item How many \alert{steps} does the task involve?
                \item Which \textit{cognitive} and \textit{motor} \alert{operators} does it involve?
                \item Is there more than one \alert{method} to complete the task?
                \item Can evaluate against initial \alert{requirements}
            \end{itemize}
        \column{.4\textwidth}
    ...
    \begin{columns}
        \column{.6\textwidth}
            \begin{itemize}
                ...
                \item How big should the buttons be? etc.
                \item Which options should be on action bars? Which should be in menus?
                \item Helps identify tasks \alert{shared} between the user and system
                \item Identify where \alert{feedback} is useful
                \item Sub-task ordering helps design \alert{dialogues}
            \end{itemize}    
        \column{.4\textwidth}
...
\frame{
    ...
    \begin{itemize}
        \item Design for how the system \alert{`asks' for information} it needs
        \item Design for how the system \alert{provides information} back to the user
        \item Allocate function and roles between the computer and the user
        \item \alert{Design} the logical flow (dialogue) of events to complete each task
        \item Ensure that the user's mental model and the system's representation of the task are compatible
    \end{itemize}
}
...
\frame{
     ...
     \begin{enumerate}
        \item What is task analysis?
        \item What does task analysis capture about a specific task?
        \item What is a `goal' in the context of task analysis?
        \item As well as focussing on the user, what else does task analysis consider?
        \item How can task analysis be used in evaluation?
        \item How can task analysis be used in design?
        \item Describe what is meant by the gulfs of execution and evaluation and how they can be `bridged'.
        \item How can task analysis help bridge the gulfs?
        \item What are the 4 main stages of task design?
        \item Describe Jackson Structured Development.
     \end{enumerate}
}
...
\frame{
    \frametitle{Summary}
    \begin{itemize}
        \item Introduction to task analysis
        \item Task analysis' role in evaluation and design
        \item The gulfs of execution and evaluation
        \item Task analysis process
        \item Hierarchical task analysis notation: Jackson Structured Development
    \end{itemize}
}    
